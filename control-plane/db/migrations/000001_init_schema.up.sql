...
-- Vexa Agent Control — Organization-First Single-Tenant Schema Baseline
...
CREATE INDEX IF NOT EXISTS idx_devices_org_team ON devices(organization_id, team_id);
CREATE INDEX IF NOT EXISTS idx_devices_heartbeat ON devices(last_heartbeat_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_device_tamper_time ON device_tamper_logs(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_spend_reservations_created ON spend_reservations(organization_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_spend_reservations_session ON spend_reservations(organization_id, session_id) WHERE session_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_spend_reservations_vk ON spend_reservations(organization_id, virtual_key_id) WHERE virtual_key_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_telemetry_org_time ON telemetry_events(organization_id, timestamp_ms DESC);
CREATE INDEX IF NOT EXISTS idx_telemetry_agent ON telemetry_events(agent_id, timestamp_ms DESC);
...
CREATE INDEX IF NOT EXISTS idx_alerts_org_time ON alerts(organization_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_audit_events_resource ON audit_events(organization_id, resource_type, occurred_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_events_action ON audit_events(organization_id, action, occurred_at DESC);
