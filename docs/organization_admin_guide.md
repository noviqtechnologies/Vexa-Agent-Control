...
| **Team Control Hub** | Up to 5 devices (Early Access) / 50 devices (GA) | Centralized SSE policy push, OIDC identity binding, vault credential custody, live spend ledger, device compliance governance | **Free for 90 Days during Early Access** (Self-hosted via Docker Compose / Helm) |
...
3. View your active organization details:
   ...
   - **Expiration Countdown:** Days remaining on your active license key or 90-day Early Access evaluation window.

### Activating a License Key
To upgrade or apply a commercial enterprise or design partner license (required after 90 days of Early Access or to connect > 5 devices):
